...
- You can specify the PHP and Zend Server version by adding ':<php-version>' or ':&lt;ZS-version&gt;-php&lt;version&gt;'  to the 'docker run' command. Availible PHP version are 7.0, 5.6, 5.5 and 5.4 (7.0 is the default), and Zend Server versions are 9, 8 or 7. For example: php-zendserver:8.5-php5.6.
